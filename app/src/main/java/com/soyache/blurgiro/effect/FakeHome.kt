...
/**
 * Rejilla de iconos tipo launcher (JVM + Android) para previsualizar
 * y para tests del look: el contenido se queda visible pero blando.
 */
object FakeHome {
    ...
    fun mask(width: Int, height: Int, tiltX: Float, tiltY: Float, mode: BlurMode, intensity: Float): FloatArray {
